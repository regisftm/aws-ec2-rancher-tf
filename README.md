# Rancher using Terraform on AWS

[![Amazon Web Services][aws-badge]][aws.link] [![Terraform][terraform-badge]][terraform.io] [![Rancher][rancher-badge]][rancher.link]

This repository was built to speed up the process of creating a Rancher server and a RKE cluster. It provides the steps to create a RKE (Rancher Kubernetes Engine) cluster through a Rancher server on AWS using EC2 instances. Also, you can find here the steps for deploying the [Online Boutique](https://github.com/GoogleCloudPlatform/microservices-demo) as an example application.
...
```bash
git clone https://github.com/regisftm/aws-ec2-rancher-tf.git
```
...
```sh
cd ./aws-ec2-rancher-tf/aws-infra
```
...
[⬆️ Back to the top](https://github.com/regisftm/aws-ec2-rancher-tf/blob/main/README.md)
